    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        {[
          ...
          {
            title: '2. Účel Služby a povolený obsah',
            content: `Služba je určena výhradně k profesionální úpravě fotografií nemovitostí (interiérů, exteriérů, pozemků, půdorysů a souvisejících snímků nemovitostí) pro účely realitní inzerce, marketingu nemovitostí a profesionální fotografie v oblasti realit.\n\nUživatel se zavazuje nahrávat výhradně fotografie spadající do výše uvedené kategorie. Nahrávání jakéhokoli jiného obsahu — zejména portrétních fotografií osob, snímků intimní povahy, fotografií dokumentů, snímků s nezákonným obsahem, materiálů porušujících práva třetích osob nebo obsahu jiného než fotografií nemovitostí — je zakázáno.\n\nTechnicky je upload omezen výhradně na obrazové soubory ve formátech JPG, PNG, TIFF, WEBP, HEIC a RAW (ARW, CR2, CR3, NEF, DNG a další). Soubory jiných typů systém odmítne při nahrávání.\n\nPoskytovatel si vyhrazuje právo bez náhrady zrušit účet a smazat data Uživatele, který tato pravidla poruší.`,
          },
          {
          ...
          {
            title: '7. Reklamace a odpovědnost za vady',
